export const Blogs = [
    {
        id: 0,
        title: "Starting to make a professional website!",
        date: "November 23rd 2022",
        description: "Thoughts on creating my first personal website",
        paragraphs: [
            "I am wanting to look more professional in the software development world, so I have decided to create a professional website for myself!",
