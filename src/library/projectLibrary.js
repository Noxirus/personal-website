...
export const TeamUnbreakable = {
    ...
    description: "CSS update to the website's aesthetics. Using references from Figma I was able to fully update the websites aesthetics. The styling technique was using " +
    "styled components, this helps keeps things organized. Also worked on making the website presentable on mobile devices using bootstrap and screen size."
}
...
export const HIMALAYASTrial = {
    ...
    description: "Website made from the ground up using React. Utilizes features from Firebase to handle messaging services along with partner matching based on filters. " + 
...
export const OmegaProtocol = {
    ...
    "adding clue systems and more support just in case the teams needed support."
}
...
export const HamlicksWebsite = {
    ...
    roles: "personal project",
    img: HamlicksImage,
    link: "https://github.com/Noxirus/Hamlicks",
    description: "A result of my initial eagerness to learn React, partway through creating the website I decided I also wanted to learn to create the backend using Express/Node.JS myself as well."
}